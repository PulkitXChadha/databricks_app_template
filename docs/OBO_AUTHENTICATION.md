...
In Databricks Apps environments, OAuth M2M credentials (DATABRICKS_CLIENT_ID, DATABRICKS_CLIENT_SECRET) exist alongside user tokens. Without an explicit Config:
