...
# Override sqlalchemy.url with environment variables for Lakebase
if not config.get_main_option("sqlalchemy.url"):
    ...
    if all([lakebase_host, lakebase_database, lakebase_token]):
        connection_string = (
            f"postgresql+psycopg2://token:{lakebase_token}@"
