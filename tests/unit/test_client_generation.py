...
def test_generated_client_has_metrics_service():
    ...
    client_path = Path(__file__).parent.parent.parent / "client" / "src" / "fastapi_client" / "services" / "MetricsService.ts"
...
def test_generated_client_type_safety():
    ...
    service_path = Path(__file__).parent.parent.parent / "client" / "src" / "fastapi_client" / "services" / "MetricsService.ts"
